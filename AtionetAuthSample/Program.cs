namespace AtionetAuthSample
{
    ...
    class Program
    {
        static async void Main(string[] args)
        {
            ...
            {
                ApplicationType = Ationet.Native.Model.Constants.ApplicationType.FleetControlSystem, ////Required field (use suggested value)
                ProcessingMode = Ationet.Native.Model.Constants.ProcessingMode.HostProcessingRequired, ////Required field (use suggested value)
                MessageFormatVersion = Ationet.Native.Model.Constants.MessageVersion.AuthMessageVersion, ////Required field (use suggested value)
            ...
            if (action.Key == ConsoleKey.C)
            {
                ...
                var completionRequest = new AuthTransactionRequest
                {
                    ...
                    AuthorizationCode = preAuthResponse.Content.AuthorizationCode ////Required field (use the Authorization Code returned in the Pre Auth)
                };
